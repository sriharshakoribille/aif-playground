...
def ql_agent():
    ...
    params = Params(
        ...
        state_size=None,
        proba_frozen=0.9,
        savefig_folder=Path("stuff/frozen_lake/ql_sandbox"),
    )
    ...
    for map_size in map_sizes:
        ...
        rewards, steps, episodes, qtables, all_states, all_actions = run_env_deterministic(env, learner, explorer, params)
